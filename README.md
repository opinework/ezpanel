...
EzPanel is built upon the work of many outstanding open source projects. We extend our sincere gratitude to:

- **[XBoard](https://github.com/cedar2025/Xboard)** — The panel API specification follows the V2Board/XBoard standard, enabling seamless compatibility with a wide ecosystem of node software.
- **[Xray-core](https://github.com/XTLS/Xray-core)** — Node functionality is powered by Xray-core, providing robust and high-performance proxy protocol support.
